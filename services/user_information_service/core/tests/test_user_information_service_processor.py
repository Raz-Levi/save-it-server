...
class TestUserInformationServiceProcessor:
    ...
    def test_set_user_information_success(self):
        ...
        self._user_information_repository.set_user_information_by_user_id.return_value = DalSetUserInformationDalResponse(is_success=True)
    ...
    def test_get_user_information_success(self):
        ...
        self._user_information_repository.get_user_information_by_user_id.return_value = DalGetUserInformationResponse(is_success=True, dal_user_information=user_information)
    ...
    def test_get_user_information_failure(self):
        ...
        user_id = '123'
        get_user_information_request = GetUserInformationRequest(user_id=user_id)
        self._user_information_repository.get_user_information_by_user_id.return_value = DalGetUserInformationResponse(is_success=False, dal_user_information=None)
